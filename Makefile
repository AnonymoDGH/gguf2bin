...
# -Isrc: los .c incluyen "internal/g2b.h" (la API pública vive en include/).
CFLAGS  ?= -O3 -mavx2 -mfma -mf16c -ffast-math -fopenmp -std=c99 -Wall -Wextra -Iinclude -Isrc -IVulkan-Headers-1.3.290/include
LDFLAGS ?= -lm -fopenmp
